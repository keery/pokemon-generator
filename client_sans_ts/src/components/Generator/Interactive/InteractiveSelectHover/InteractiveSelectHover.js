...
const retreatLogo = `${process.env.REACT_APP_FRONT_URL}/assets/1-gen/normal.png`

const InteractiveSelectHover = ({
  name,
  max,
  defaultValue,
  handleClick,
  ...
  if (count < max) {
    ...
    ico.pop()
    ico.push(
      <span className="more-icon" key="retreat-l">
        <img src={retreatLogo} alt="" />
      </span>,
    )
  }
