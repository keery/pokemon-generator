...
import CardAttackElement from "~src/components/Gallery/CardAttackElement";
import CardModalAttackMobile from "~src/components/Gallery/CardModal/CardModalAttackMobile";
