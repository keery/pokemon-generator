...
import WinnerGlass from "~src/components/Gallery/Winner/WinnerGlass";
import WinnerGlassMobile from "~src/components/Gallery/Winner/WinnerGlassMobile";
import useWinner from "~hooks/useWinner";
import { useTranslations } from "next-intl";
import ParallaxY from "~src/components/ParallaxY";
import { screenPercent } from "~utils/helper";
import HoloCard from "~src/components/Gallery/HoloCard";
